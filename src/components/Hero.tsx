...
import ufersaLogo from '@/images/logos/ufersa.webp'
import sabiaLogo from '@/images/logos/sabia.png'
import gravacaoPrint from '@/images/gravacao.png'
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900">
              A voz de todos merece ser ouvida.
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              Conheça a iniciativa que está tornando o ensino e a informação
              acessíveis para pessoas com deficiência auditiva.
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              {/* <AppStoreLink /> */}
              <Button href={'/#problema'}>
          ...
          <div className="relative -mt-4 lg:col-span-7 lg:mt-0 xl:col-span-6">
            <p className="text-center text-sm font-semibold text-gray-900 lg:text-left">
              Empresas que acreditam na inclusão:
            </p>
            <ul
              role="list"
